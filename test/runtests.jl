...
@testset "FixedSizeArrays" begin
    ...
    @testset "Constructors" begin
        ...
        @testset "taken from Julia's test/core.jl" begin
            ...
            @test_throws ArgumentError FixedSizeArray{Int, 2}(undef, 0, -10)
            @test_throws ArgumentError FixedSizeArray{Int, 2}(undef, -10, 0)
            @test_throws ArgumentError FixedSizeArray{Int, 2}(undef, -1, -1)
